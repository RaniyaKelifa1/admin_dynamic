...
import { FileTextOutlined, BarChartOutlined, DollarOutlined, CalculatorOutlined, SyncOutlined, LogoutOutlined } from "@ant-design/icons";
...
const FinanceMenu = () => {
  ...
  const navItems = [
    { key: "home", icon: <FileTextOutlined />, label: "Overview", path: "/FinanceDashboard/Home" },
    { key: "ledger", icon: <BarChartOutlined />, label: "General Ledger", path: "/FinanceDashboard/Ledger" },
    { key: "payments", icon: <SyncOutlined />, label: "Payments", path: "/FinanceDashboard/Payments" },
    { key: "commissions", icon: <DollarOutlined />, label: "Commissions", path: "/FinanceDashboard/Commissions" },
    { key: "reports", icon: <BarChartOutlined />, label: "Reports", path: "/FinanceDashboard/Reports" },
  ];
