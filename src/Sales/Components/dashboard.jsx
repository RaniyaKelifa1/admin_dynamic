...
import { Layout, Menu, Typography, Dropdown, Button, notification, Divider } from "antd";
...
const Dashboard = () => {
 ...
 const handleLogout = async () => {
  ...
  const navItems = [
    { to: "/dashboard/ReportProspect", icon: <HomeOutlined />, label: "Home" },
    { to: "/dashboard/AddProspect", icon: <PlusOutlined />, label: "Add Prospect" },
    { to: "/dashboard/DataProspect", icon: <EyeOutlined />, label: "Data Prospects" },
  ];

  return (
    <Layout style={{ minHeight: "100vh", width: "100vw" ,   fontFamily: 'Noto Sans,  Sans' }}>
